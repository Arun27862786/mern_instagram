...
const Home = () => {
  ...
  useEffect(() => {
    fetch("/following", {
      ...
      .then((res) => res.json())
      .then((result) => {
        setFollow(result.following.following);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  return (
    <div className="home">
      <div className="card home-card hoverable" style={{ padding: "20px" }}>
        {follow.map((items) => {
          return (
            <div>
              <img
                ...
                style={{ width: "80px" }}
                src={items.pic ? items.pic : "loading"}
                alt="profile"
              />
      ...
      {data.map((item) => {
        return (
          <div className="card home-card hoverable" key={item._id}>
            ...
            <div>
              <img src={item.photo} alt="wallpaper" style={{ width: "100%" }} />
            </div>
